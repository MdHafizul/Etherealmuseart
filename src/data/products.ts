...
import nikahnama1 from "@/assets/nikahnama-1.jpg";
import nikahnama2 from "@/assets/nikahnama-2.jpg";
...
export interface Artwork {
  ...
  title: string;
  image: string;
  category: "NikahNama" | "Sampul Raya" | "Illumination Art";
  year: string;
}

export interface NikahNamaPackage {
  id: string;
  name: string;
  price: number;
  description: string;
...
export const artworks: Artwork[] = [
  { id: "a1", title: "NikahNama — Gold Illumination", image: nikahnama1, category: "NikahNama", year: "2024" },
  { id: "a2", title: "NikahNama — Classic Foliage", image: nikahnama2, category: "NikahNama", year: "2024" },
...
export const nikahnamaPackages: NikahNamaPackage[] = [
  {
    id: "nn-classic",
    name: "Classic",
    price: 350,
    description: "A beautifully handcrafted NikahNama with traditional Islamic geometric borders.",
  ...
  },
  {
    ...
    name: "Bespoke",
    price: 900,
    description: "A fully bespoke NikahNama — collaborate directly with the artist for a one-of-a-kind piece.",
...
export const experiences = [
  ...
  { year: "2024", title: "NikahNama Exhibition — Islamic Arts Museum", description: "Solo showcase of handcrafted marriage certificates." },
